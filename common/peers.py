...
sig_length = len(max(close_signal, peer_request, bounty_request, incoming_bounties, incoming_bounty, valid_signal, invalid_signal, transact_bounty, fetch_test, test_results, fetch_main, main_results, bounty_received, end_of_message, key=len))
